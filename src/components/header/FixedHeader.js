...
const FixedHeader = () => {
  ...
  const handleRoomOptions = (name, operation) => {
    setRoomOptions((prev) => {
      return {
        ...prev,
        [name]:
  ...
  return (
    <>
      {!dropdownHeader ? (
        <div className="" onClick={() => setDropDownHeader(true)}>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-3">
              {<div className="h- bg-white py- w-full">
                <div className="searchItem">
                  ...
                  <span className="pl-8 w-full py-4 cursor-pointer" onClick={toggleDate}>
                    ...
                    <div className="options">
                      ...
                      <div className="w-52 flex justify-between mt-3 py-2 px-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-black">
                          <button
                            ...
                            onClick={() => handleRoomOptions("adult", "d")}
                          ...
                          <button
                            className="w-7 h-7 cursor-pointer text-gray-900 border border-gray-900 btn-disabled"
                            onClick={() => handleRoomOptions("adult", "i")}
                          >
                            +
                          </button>
                        </div>
                      ...
                      <div className="w-52 flex justify-between mt-3 py-2 px-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-black">
                          <button
                            className="w-7 h-7 cursor-pointer text-gray-900 border border-gray-900 btn-disabled"
                            onClick={() => handleRoomOptions("children", "d")}
                          ...
                          <button
                            className="w-7 h-7 cursor-pointer text-gray-900 border border-gray-900 btn-disabled"
                            onClick={() => handleRoomOptions("children", "i")}
                          >
                            +
                          </button>
                        </div>
                      ...
                      <div className="w-52 flex justify-between mt-3 py-2 px-4">
                        ...
                        <div className="flex items-center gap-2 text-xs text-black">
                          <button
                            className="w-7 h-7 cursor-pointer text-gray-900 border border-gray-900 btn-disabled"
                            onClick={() => handleRoomOptions("rooms", "d")}
                          ...
                          <button
                            className="w-7 h-7 cursor-pointer text-gray-900 border border-gray-900 btn-disabled"
                            onClick={() => handleRoomOptions("rooms", "i")}
                          >
                            +
                          </button>
                        </div>
